...
--   :lua kgdb_load_module mydriver
--
-- Env:
--   GDBFORGE_KGDB_MODULES=/path/to/kernel-source   search tree for module.ko
--   GDBFORGE_KGDB_KO=/path/to/mydriver.ko          override .ko path
--   GDBFORGE_KGDB_VERIFY=mydriver                    optional info functions check
...
function help()
  ...
  gdbforge.print("Env:")
  gdbforge.print("  GDBFORGE_KGDB_MODULES=/path/to/kernel-source")
