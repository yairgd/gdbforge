...
type layoutHost interface {
	...
	LayoutCodePane() termforge.Widget
	DebugPanes(code termforge.Widget) layout.Panes
	AsmPreferAsm() bool
	AsmHasSplit() bool
...
func (a *DebuggerApp) LayoutCodePane() termforge.Widget              { return a.layoutCodePane() }
func (a *DebuggerApp) DebugPanes(code termforge.Widget) layout.Panes { return a.debugPanes(code) }
