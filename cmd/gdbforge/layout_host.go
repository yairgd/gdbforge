...
type layoutHost interface {
	...
	LayoutCodePane() termforge.NodeWidget
	DebugPanes(code termforge.NodeWidget) layout.Panes
	AsmPreferAsm() bool
	AsmHasSplit() bool
...
func (a *DebuggerApp) LayoutCodePane() termforge.NodeWidget              { return a.layoutCodePane() }
func (a *DebuggerApp) DebugPanes(code termforge.NodeWidget) layout.Panes { return a.debugPanes(code) }
