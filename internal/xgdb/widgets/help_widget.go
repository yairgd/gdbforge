...
func buildHelpLines() []string {
	return []string{
		...
		"",
		"Layout:",
		"    :layout panels     startup layout (Code|GDB left; Output +",
		...
		"        Clear Output pane when GDB session starts (default on).",
		...
		"    Startup shows the xgdb logo until a source file is opened",
